...
| 8 | message_start_time | Timestamp | Earliest message log_time in the file. Zero if the chunk has no messages. |
| 8 | message_end_time | Timestamp | Latest message log_time in the file. Zero if the chunk has no messages. |
