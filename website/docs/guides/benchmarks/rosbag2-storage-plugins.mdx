---
sidebar_label: Rosbag2 Storage Plugins
---

# Comparison of Rosbag2 Storage Plugins

_[James Smith](https://github.com/james-rms)_<br/>
_November 2022_
...
<ul>
  <li>
    <a download target="_blank" href="/files/m1_throughput_results.csv">
      Apple M1 Pro results
    </a>
  </li>
  <li>
    <a download target="_blank" href="/files/nuc_throughput_results.csv">
      Intel NUC7i5BNH results
    </a>
  </li>
</ul>
...
<div style={{ display: "flex", flexWrap: "wrap", padding: "0 4px" }}>
  <div style={{ flex: "50%", padding: "0 4px" }}>
    <img
      src={require("./throughput/m1/1MiB_1KiB.png").default}
      title="M1 Throughput, 1MiB messages, 1KiB cache"
    />
    <img
      src={require("./throughput/m1/1MiB_10MiB.png").default}
      title="M1 Throughput, 1MiB messages, 10MiB cache"
    />
    <img
      src={require("./throughput/m1/10KiB_1KiB.png").default}
      title="M1 Throughput, 10KiB messages, 1KiB cache"
    />
    <img
      src={require("./throughput/m1/10KiB_10MiB.png").default}
      title="M1 Throughput, 10KiB messages, 10MiB cache"
    />
    <img
      src={require("./throughput/m1/100B_1KiB.png").default}
      title="M1 Throughput, 100B messages, 1KiB cache"
    />
    <img
      src={require("./throughput/m1/100B_10MiB.png").default}
      title="M1 Throughput, 100B messages, 10MiB cache"
    />
    <img
      src={require("./throughput/m1/mixed_1KiB.png").default}
      title="M1 Throughput, mixed messages, 1KiB cache"
    />
    <img
      src={require("./throughput/m1/mixed_10MiB.png").default}
      title="M1 Throughput, mixed messages, 10MiB cache"
    />

  </div>
  <div style={{ flex: "50%", padding: "0 4px" }}>
    <img
      src={require("./throughput/nuc/1MiB_1KiB.png").default}
      title="nuc throughput, 1MiB messages, 1KiB cache"
    />
    <img
      src={require("./throughput/nuc/1MiB_10MiB.png").default}
      title="nuc throughput, 1MiB messages, 10MiB cache"
    />
    <img
      src={require("./throughput/nuc/10KiB_1KiB.png").default}
      title="nuc throughput, 10KiB messages, 1KiB cache"
    />
    <img
      src={require("./throughput/nuc/10KiB_10MiB.png").default}
      title="nuc throughput, 10KiB messages, 10MiB cache"
    />
    <img
      src={require("./throughput/nuc/100B_1KiB.png").default}
      title="nuc throughput, 100B messages, 1KiB cache"
    />
    <img
      src={require("./throughput/nuc/100B_10MiB.png").default}
      title="nuc throughput, 100B messages, 10MiB cache"
    />
    <img
      src={require("./throughput/nuc/mixed_1KiB.png").default}
      title="nuc throughput, mixed messages, 1KiB cache"
    />
    <img
      src={require("./throughput/nuc/mixed_10MiB.png").default}
      title="nuc throughput, mixed messages, 10MiB cache"
    />
  </div>
</div>
