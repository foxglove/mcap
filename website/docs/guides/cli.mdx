...
import CLIDownloadScript from "../../src/components/CLIDownloadScript";
...
Use the asset links on https://github.com/foxglove/mcap/releases to download the latest binary for your platform:
